...
```bash
git clone https://github.com/PaulaEmy/AV5_TPII.git
cd AV5_TPII
```

## Configuração do Banco de Dados

Abra o MySQL Workbench (ou outro cliente SQL) e execute o script abaixo para criar o banco de dados e popular as tabelas iniciais:
...
-- ============================================
-- TABELA: clientes
-- Armazena clientes titulares e dependentes
-- ============================================
...
-- ============================================
-- TABELA: documentos
-- Armazena CPF, RG, Passaporte, etc.
-- ============================================
...
-- ============================================
-- TABELA: acomodacoes
-- Define os tipos de acomodação do hotel (Tabela 1)
-- ============================================
...
-- ============================================
-- DADOS INICIAIS - Tipos de acomodação (Tabela 1)
-- ============================================
